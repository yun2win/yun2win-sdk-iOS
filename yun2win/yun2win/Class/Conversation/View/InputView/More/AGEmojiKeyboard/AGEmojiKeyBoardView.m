...
static const CGFloat ButtonWidth = 37;
...
- (instancetype)initWithFrame:(CGRect)frame dataSource:(id<AGEmojiKeyboardViewDataSource>)dataSource {
  self = [super initWithFrame:frame];
    if (self) {
        ...
        self.emojiSendBTN.layer.borderColor = [UIColor colorWithHexString:@"888888"].CGColor;
        [self.emojiSendBTN setTitle:@"发送" forState:UIControlStateNormal];
        [self.emojiSendBTN setTitleColor:[UIColor colorWithHexString:@"888888"] forState:UIControlStateNormal];
...
- (void)setSendButtonEnabled:(BOOL)sendButtonEnabled {
    ...
    self.emojiSendBTN.enabled = _sendButtonEnabled;
}
